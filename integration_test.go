...
func TestIntegration(t *testing.T) {
	...
	// SAVE_SNAPSHOT=1 go1.25 test -run ^TestIntegration/adhoc_dependency_condition_disabled$ ./
	runTest(t, integrationTestCase{
	...
	// SAVE_SNAPSHOT=1 go1.25 test -run ^TestIntegration/adhoc_dependency_condition_default$ ./
	runTest(t, integrationTestCase{
	...
	// SAVE_SNAPSHOT=1 go1.25 test -run ^TestIntegration/force_namespace$ ./
	runTest(t, integrationTestCase{
	...
	// SAVE_SNAPSHOT=1 go1.25 test -run ^TestIntegration/kube_version_and_api_versions$ ./
	runTest(t, integrationTestCase{
	...
	// SAVE_SNAPSHOT=1 go1.25 test -run ^TestIntegration/disabled_inaccessible_chart_yaml_dep$ ./
	runTest(t, integrationTestCase{
	...
	// SAVE_SNAPSHOT=1 go1.25 test -run ^TestIntegration/local_chart_with_adhoc_dependency$ ./
	runTest(t, integrationTestCase{
	...
	// SAVE_SNAPSHOT=1 go1.25 test -run ^TestIntegration/local_chart_with_slash_at_the_end$ ./
	...
	// SAVE_SNAPSHOT=1 go1.25 test -run ^TestIntegration/local_chart_with_dot_at_the_end$ ./
	// Related to https://github.com/helmfile/chartify/pull/13
	runTest(t, integrationTestCase{
	...
	// SAVE_SNAPSHOT=1 go1.25 test -run ^TestIntegration/local_chart_with_release_namespace$ ./
	// Related to https://github.com/helmfile/chartify/pull/13
	runTest(t, integrationTestCase{
	...
	// SAVE_SNAPSHOT=1 go1.25 test -run ^TestIntegration/local_chart_with_chart_name_unequal_to_dir_name$ ./
	...
	// SAVE_SNAPSHOT=1 go1.25 test -run ^TestIntegration/local_tgz_chart$ ./
	runTest(t, integrationTestCase{
	...
	// SAVE_SNAPSHOT=1 go1.25 test -run ^TestIntegration/local_chart_with_import_values$ ./
	runTest(t, integrationTestCase{
	...
	// SAVE_SNAPSHOT=1 go1.25 test -run ^TestIntegration/kube_manifest_with_adhoc_dep$ ./
	runTest(t, integrationTestCase{
	...
	// SAVE_SNAPSHOT=1 go1.25 test -run ^TestIntegration/kube_manifest_with_patch$ ./
	runTest(t, integrationTestCase{
	...
	// SAVE_SNAPSHOT=1 go1.25 test -run ^TestIntegration/kube_manifest_yml_with_patch$ ./
	runTest(t, integrationTestCase{
